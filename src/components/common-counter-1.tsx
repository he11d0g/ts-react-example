...
export class CommonCounter1 extends StoreComponent<Props, State, StoresState> {
    constructor() {
        super({
    ...
    render() {
        return (
            <div>
                <h1>Common counter 1</h1>
                <h2>Common counter "{this.props.name}": {this.stores.common.state.counter}</h2>
                <a href="#" onClick={this.increaseCommon.bind(this)}>+1 to common</a>
            </div>
        );
    }
}